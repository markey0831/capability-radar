export const CAPABILITY_CATEGORIES = ['通用基础能力', '专业核心能力', '职业素养能力'] as const
...
export interface AssessmentResult {
  person: Omit<AssessmentPerson, 'roleId'> & { roleId: RoleId }
  roleName: string
  roleTitleEn: string
...
export interface HistorySummary {
  ...
  biggestImprovement: { name: string; delta: number } | null
  biggestDecline: { name: string; delta: number } | null
}
